...
type KVRevisionCacher interface {
	Check(entryID keybase1.KVEntryID, entryHash string, teamKeyGen keybase1.PerTeamKeyGeneration, revision int) (err error)
	FetchRevision(entryID keybase1.KVEntryID) (revision int)
}
